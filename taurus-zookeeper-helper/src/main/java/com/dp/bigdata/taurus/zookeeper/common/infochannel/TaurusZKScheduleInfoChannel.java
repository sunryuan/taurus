...
//	private static final String RESTART = "restart";
	private static final Log LOGGER = LogFactory
			.getLog(TaurusZKScheduleInfoChannel.class);
	...
	@Override
	public void execute(String ip, String attemptID, Object conf, Object status) {
		try {
	 ...
	 * ScheduleInfoChannel#addRunningJob(java.lang.String, java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see com.dp.bigdata.taurus.zookeeper.common.infochannel.interfaces.
	 * ScheduleInfoChannel#removeRunningJob(java.lang.String, java.lang.String)
	 */
	@Override
	 ...
	 */
	@Override
	public void completeOperate(String ip, String op) {
		if (checkOperate(op)) {
			rmPath(BASE, SCHEDULE, ip, op);
		}
	}
	 ...
	 * 
	 * @see com.dp.bigdata.taurus.zookeeper.common.infochannel.interfaces.
	 * ScheduleInfoChannel#newUpdate(java.lang.String)
	 */
	@Override
	public boolean newOperate(String ip, String op) {
		if (checkOperate(op)) {
			mkPathIfNotExists(BASE, SCHEDULE, ip, op);
			return true;
		} else {
			return false;
		}
	...
	private boolean checkOperate(String op) {
		if (op != null) {
			for(Operate opSupported : Operate.values()){
				if(op.equalsIgnoreCase(opSupported.name())){
					return true;
				}
			}
			
		} else {
			LOGGER.error("wrong operate " + op);
			return false;
		}
		return false;
	}

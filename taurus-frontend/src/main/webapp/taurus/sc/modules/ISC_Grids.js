...
,isc.A.$866=function isc_Tree__filterChildren(_1,_2,_3,_4){if(_4.children==null||_4.children.length==0)return false;var _5=_4.children,_6=false;for(var i=_5.length-1;i>=0;i--){var _8=_5[i],_9=false;if(_8.children!=null&&_8.children.length>0){_9=this.$866(_1,_2,_3,_8)}
...
var _73=isc.Canvas.ariaEnabled();var _74=[],_75=0,_76=[];this.$50d(_28,_38,_46,_52);if(this.isPrinting&&(!this.$568||_2==0)){_31.append(this.grid.getPrintHeaders(_26,_27))}
...
if(!this.$568||_3==this.getTotalRows())_31.append("</TABLE>");var _101=_15-_3,_102=(!_13&&this.$60s);var _103=this.cacheDOM?0:(this.endSpace||0);this.$515=0;if(!this.showAllRows&&(_101!=0||_102)){var _104=_101*this.getAvgRowHeight();if(_102&&_101==0){var _105=this.getViewportHeight();if(_104<_105){_104=_105}}
...
return null}
return _110}
,isc.A.$86a=function isc_GridRenderer__putNativeFocusInRow(_1,_2){var _3=this.screenReader_suppressHandleFocus;if(_3)this.$vj(false);this.$86b=_1;if(_3)this.$vj(true);if(_2||!this.hasFocus)return;var _4=this.getFocusHandle();if(_4)_4.focus();if(!_3)isc.EH.$ke=null;_4.focus();if(!_3)isc.EH.$ke=this}
...
,isc.A.getNativeFocusRow=function isc_GridRenderer_getNativeFocusRow(){var _1=this.$86b;if(_1==null)_1=this.getFocusRow();var _2=this.getVisibleRows();if(_2!=null&&_2.length>0&&(_1==null||_1<_2[0]||_1>_2[1])){_1=this.getVisibleRows()[0];if(this.getRowTop(_1)<this.getScrollTop())_1+=1}
return _1}
...
,isc.A.$29t=function isc_GridRenderer__rowSelectionChanged(_1,_2,_3){if(!_3){if(this.handleSelectionChanged(_1,_2)==false){this.logWarn("bailing!!");return false}}
...
,isc.A.selectOnMouseDown=function isc_GridRenderer_selectOnMouseDown(_1,_2,_3){if(!this.selectionEnabled())return true;if(_2>=0&&_3>=0&&this.canSelectRecord(_1)&&!this.$89v()){this.$828=true;this.selection.selectOnMouseDown(this,_2,_3)}}
...
this.selection.selectOnMouseUp(this,_2,_3);if(this.$828){if(this.fireSelectionUpdated)this.fireSelectionUpdated();this.$828=null}}}
...
{this.$518(_8)}else{delete this.$519}}else if(_6!=null){_5.$30b(null,null,this)}else if(isc.screenReader&&this.hasFocus&&_15){this.$86a(this.getNativeFocusRow())}}
...
if(_1&&_4==null&&isc.screenReader){var _3=isc.EH.lastEvent,_6=_3.eventType;var _7=this.getNativeFocusRow();_5.$88(_7);this.$86a(_7)}
return _2}
,isc.A.$86a=function isc_GridBody__putNativeFocusInRow(_1){var _2=this.grid;if(_2)_2.$88(_1);return this.Super("$86a",arguments)}
...
return this.Super("$315",arguments)}})}else{this.summaryRow.setDataSource(this.getSummaryRowDataSource());this.summaryRow.setFields(this.completeFields.duplicate());this.summaryRow.$855()}
...
);isc.evalBoundary;isc.B.push(isc.A.$33l=function isc_ListGrid__storeEditValue(_1,_2,_3,_4,_5){var _6=true,_7=false,_8,_9,_10,_11;_8=this.getEditSession(_1,_2)
...
return _1}
);isc.evalBoundary;isc.B.push(isc.A.$339=function isc_ListGrid__editCompleteCallback(_1,_2,_3,_4){if(this.$30a&&this.getEditForm().hasFocus)this.storeUpdatedEditorValue(true);var _5=_1.rowNum,_6=_1.colNum,_7=_1.editValuesID,_8=this.getEditSession(_7);var _9;if(_3!=null){var _10=isc.DataSource.getUpdatedData(_4,_3,true),_9=isc.isAn.Array(_10)?_10[0]:_10;if(_9==null){return}
...
,isc.A.displayHeaderContextMenu=function isc_ListGrid_displayHeaderContextMenu(_1,_2){if(!_1)return;var _3=this.fields[_1.masterIndex];if(_3&&_3.showDefaultContextMenu==false)return false;var _4=this.getHeaderContextMenuItems(_1.masterIndex);if(_4.length==0)return;if(!this.$314)this.$314=this.getHeaderContextMenu(_1);this.$314.setData(_4);if(_2!=null&&_2.length>0){this.$314.moveTo(0,0);this.$314.setVisibility("hidden");if(!this.$314.isDrawn())this.$314.draw();else this.$314.redraw();this.$314.placeNear(_2[0],_2[1]);this.$314.show();return false}else{return this.$314.showContextMenu(_1)}}
...
return _3}
);isc.evalBoundary;isc.B.push(isc.A.getHeaderContextMenu=function isc_ListGrid_getHeaderContextMenu(){return this.createAutoChild("headerContextMenu",{ID:this.getID()+"$314",grid:this})}

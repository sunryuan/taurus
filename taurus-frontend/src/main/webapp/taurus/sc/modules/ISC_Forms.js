...
var _23=isc.DynamicForm.$817();for(var _21=0;_21<_13.length;_21++){if(!isc.isA.Number(_13[_21])){_1.append(_23.join(isc.emptyString),this.$9y)}else{var _18=_13[_21];_18-=(this.cellSpacing!=null?(2*this.cellSpacing):0);_23[3]=(isc.FormItem?isc.FormItem.getPrototype().baseStyle:null);var _24=isc.Browser.isIE?1:0,_25=_23.join(isc.emptyString);_1.append(_25,this.fixedColWidths?isc.Canvas.spacerHTML(_18,_24):null,this.$9y)}}
...
var _5;if(_3&&_3.item){var _6=_3.item;if(_6.isReadOnly())return this.Super("handleClick",arguments);if(_3.inactiveContext){this.logInfo("Bubbling inactive editor event for "+_6.ID,"EventHandler");_5=this.bubbleInactiveEditorEvent("click",_6,_3)}else{if(_3.overTitle){this.logInfo("Bubbling handleTitleClick event for "+_6.ID,"EventHandler");_5=this.bubbleItemHandler(_6,"handleTitleClick",_6)}else{var _7=(_3.overElement||_3.overTextBox||_3.overControlTable);_7=_7||_6.isA("SpacerItem");if(_3.overIcon&&(_6.form==this)){if(_6.$116(_3.overIcon)==false)
...
);isc.evalBoundary;isc.B.push(isc.A.handleKeyDown=function isc_DynamicForm_handleKeyDown(_1,_2){var _3
...
);isc.B._maxIndex=isc.C+234;isc.A=isc.DynamicForm;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.defaultFieldType="text";isc.A.$12a="link";isc.A.$gx="text";isc.A.$12b="select";isc.A.$12c="checkbox";isc.A.$12d="staticText";isc.A.$g2="boolean";isc.A.$12e="binary";isc.A.$12f="blob";isc.A.$52w="multifile";isc.A.$12g="multiupload";isc.A.$9i="upload";isc.A.$52x="file";isc.A.$51x="base64Binary";isc.A.$12h="enum";isc.A.$12i="CycleItem";isc.A.$12j="selectOther";isc.A.$12k="relation";isc.A.$67f="NestedEditorItem";isc.A.$67g="NestedListEditorItem";isc.A.$677="imageFile";isc.A.$678="ViewFileItem";isc.A.$77j="section";isc.A.$77k="SectionItem";isc.A.$77l="button";isc.A.$77m="ButtonItem";isc.A.$450="id";isc.A.$refPropName="__ref";isc.B.push(isc.A.getEditorType=function isc_c_DynamicForm_getEditorType(_1,_2){if(_1._constructor==isc.FormItem.Class)_1._constructor=null;var _3=_2.getDataSource();var _4=this.canEditField(_1,_2),_5=this.defaultFieldType,_6=(_4==false&&_1.readOnlyEditorType)||_1.editorType||_1.formItemType||_1._constructor||_1.type||_5;if((_4==false&&_1.readOnlyEditorType)||_1.editorType||_1.formItemType||_1._constructor)
{return _6}
...
return _6}
,isc.A.canEditField=function isc_c_DynamicForm_canEditField(_1,_2){if(_2&&_2.canEditField)return _2.canEditField();var _3=(_2&&_2.canEditFieldAttribute)||"canEdit";if(_1[_3]!=null)return _1[_3];if(_2.canEdit!=null)return _2.canEdit;if(_1.canSave==false&&(!_2||!_2.$66m)){return false}
return true}
...
,isc.A.isReadOnly=function isc_FormItem_isReadOnly(){if(this.canEdit!=null)return!this.canEdit;var _1=this;while(_1.parentItem){if(_1.parentItem.canEdit!=null)return!_1.parentItem.canEdit;_1=_1.parentItem}
if(this.form&&this.form.canEdit!=null)return!this.form.canEdit;return false}
...
if(isc.Browser.isIE){var _5=_4.createTextRange();_5.collapse(true);_5.moveStart(this.$14n,_1);_5.moveEnd(this.$14n,(_2-_1));_5.select()}else{_4.focus();_4.setSelectionRange(_1,_2)}}
...
);isc.evalBoundary;isc.B.push(isc.A.$154=function isc_FormItem__getElementTabIndex(_1){if(this.isInactiveHTML()||(!_1&&this.isDisabled()))
{return-1}
...
,isc.A.iconIsDisabled=function isc_FormItem_iconIsDisabled(_1,_2){_1=this.getIcon(_1);if(!_1)return;if(this.containerWidget&&this.containerWidget.isDisabled())return true;if(_1.neverDisable)return false;return this.isDisabled()||(!_2&&this.isReadOnly())}
...
var _2={_redrawWithParent:false,$so:true,tabIndex:-1,canvasItem:this,disabled:this.shouldDisableCanvas()};_2.resized=this.$18v;_2.dragResized=this.$18w;_2.handleClick=function(){this.Super("handleClick",arguments);if(!isc.isA.StatefulCanvas(this)&&this.canvasItem){this.canvasItem.handleClick()}}
...
if(this.mask){this.$717(false);var _4=0;var _5=this.$718;var _6=this.$884();if(!_6){_4=this.$719();_5=_4}
...
return false;if(this.isReadOnly())return true;if(isc.EventHandler.ctrlKeyDown()||isc.EventHandler.altKeyDown())return true;if((!this.characterCasing||this.characterCasing==isc.TextItem.DEFAULT)&&!this.$66y&&!this.mask)
{return true}
...
);isc.B._maxIndex=isc.C+3;isc.ClassFactory.defineClass("LinkItem","TextItem");isc.A=isc.LinkItem.getPrototype();isc.A.wrap=false;isc.A.canEdit=false;isc.A.readOnlyTextBoxStyle="staticTextItem";isc.A=isc.LinkItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$14g=["<DIV ID='",,"' "+isc.DynamicForm.$89+"='",,,"' CLASS='",,"' STYLE='",,"'>",,"</DIV>"];isc.B.push(isc.A.$15m=function isc_LinkItem__writeOutFocusProxy(){return(this.isReadOnly()?false:this.Super("$15m",arguments))}
...
var _18=_1.getValue(_15);if(_18===_11){isc.DynamicForm.$70m(_15,this.values)}else{isc.DynamicForm.$70n(_15,_1.getValue(_15),this.values,_1)}}
if(_2){this.$709(_1)}}}

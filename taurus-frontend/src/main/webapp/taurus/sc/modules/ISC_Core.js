 ...
 */
if(typeof isomorphicDir == 'undefined'){isomorphicDir = 'taurus/sc/';}
...
if(isc.Browser.isTouch&&isc.Browser.isAndroid){if(this.$893==null){this.$893=_4;this.$26u=isc.Page.getWidth(_1,_2)}else{if(_4!=this.$893){var _5=isc.Page.getWidth(_1,_2);if(_5==this.$26u){_4=this.$893}else{this.$893=_4;this.$26u=_5}}}}
...
_3.$85t[_3.$85t.length]=_4.keyName;_3.$885=_4.ctrlKey;_3.$886=_4.altKey;if(_5!=false&&((isc.Browser.isIE&&_3.$85z[_4.keyName]!=true&&_3.$i8[_4.keyName]!=null)||(isc.Browser.isMoz&&_4.keyName==this.$je&&this.shiftKeyDown())))
...
if(_2.$78m!=null)isc.Timer.clear(_2.$78m)}
,isc.A.$86w=function isc_c_EventHandler__handleTouchCancel(_1){var _2=isc.EH;_2.DOMevent=_1;var _3=_2.getMouseEventProperties(_1);this.delayCall("$894",[_3,_1])}
...
this[_5]=null;var _13=false;if(!isc.isA.Number(_2)||(_2<0&&(_1==this.$o6||_1==this.$o5)))
{if(_12!="*"){this.logWarn("ignoring bad or negative "+_1+": "+_12+(this.logIsDebugEnabled("sizing")?this.getStackTrace():" [enable 'sizing' log for stack trace]"))}else{_1==this.$o6?this.$pn="*":this.$po="*";var _7=this.parentElement;if(isc.isA.Layout(_7)&&_7.hasMember(this)){_7.reflow(this.getID()+" set "+_1+" to '*'");_13=true}}
...
if(_10.type==null&&this.$308[_10.editorType]==true){var _12=_10.name;var _11=(_12!=null)?_4.getField(_12):null;if(_11==null||_11.type==null){_10.type="date"}}
...
if(!this.exportAll&&!_1.exportFields){var _5=this.exportFields;if(!_5){_5=[];for(var i=0;i<this.fields.length;i++){var _7=this.fields.get(i);if(this.$71s(_7)){_5.add(_7.name);if(_7.displayField&&!_7.optionDataSource)_5.add(_7.displayField)}}}
